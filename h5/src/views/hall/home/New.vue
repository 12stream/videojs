...
<div class="new">
  <div v-if="play.length !== 0">
    <div v-for="(item,i) in play" :key="i" @click="toLive(item)">
    ...
    <!-- <div class="bottom-more" v-if="newMoreFlag">下拉加载更多！</div> -->
    <Wait class="bottom-more" v-if="newMoreFlag"></Wait>
    <div class="no-more" v-if="noMoreFlag">已经到底啦！</div>
  </div>
  <div v-else-if="loadingNF" class="nothingdata">
        <Wait></Wait>
    </div>
...
export default {
    ...
    props:['tabNumber', 'totalNumber', 'newMoreFlag'],
    methods:{
      toLive(res) {
