...
export default {
    ...
    methods:{
        ...
        liveAppointment() {
            ...
            if(!getLStorage('mobile') && !is_weixn()){
                this.flag = true
            ...
            this.$ajax.liveAppoint(params).then(res =>{
                ...
                if(res.data) {
                    ...
                    this.show = false
                    // 直播
                    console.log('免费预告返回情况',this.liveDetailsData.live_permit)
                    if(this.liveDetailsData.live_statu == 1) {
                        this.payState = true
                        this.headimgstate = false
                        this.showVideoFlag = true
        ...
        payLiveState() {
            ...
            this.$ajax.livePay(params).then(res =>{
                console.log('sfff',JSON.stringify(res))
        ...
        pay(){
            ...
            }else if(getLStorage('mobile') && !is_weixn()){
                this.flag = true
                this.loginState = 'loginF'
            }
        ...
        getLiveDetails() {
            ...
            this.$ajax.liveDetails({id:curid || this.$route.params.liveId}).then(res =>{
                console.log(res)
                ...
                if(res.code == '200') {
                    ...
                    setLStorage('payPer',res.data.live_permit)
    ...
    mounted(){
        console.log(11113333333331111,JSON.parse(getLStorage('wxUserData')))
        // 若在当前页授权，则授权之后跳转到当前页
        console.log('测试缓存',this.liveDetailsData.live_permit)
        this.getLiveDetails()
        ...
        eventVue.$on('payFT',res=>{
            ...
            console.log('测试免费跳转',getLStorage('payPer'))
            if(res && getLStorage('payPer') == 2) {
                this.pay()
            }else if(res && getLStorage('payPer') == 0){
                this.liveAppointment()
            }
        })
    },
