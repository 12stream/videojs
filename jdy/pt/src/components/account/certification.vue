<template>
    <div class="my_list certification ">
        ...
        <div class="bg-fff col-333 content">
            <el-row v-show="noSubmit"  class="table_form mt30">
                <el-form  label-width="80px"  status-icon  :model="ruleForm" :rules="rules" ref="ruleForm">
                    <div class="content_section" >
                        <div class="title">个人信息</div>
                        <el-row :gutter="20" class="Tf_content">
                            <el-col :span="12">
                                <el-form-item :span="6" label="真实姓名 :" prop="rzName">
                                    <el-input v-model="ruleForm.rzName" style="width: 192px;"></el-input>
                                </el-form-item>
                                <el-form-item :span="6" label="身份证号 :" prop="rzCard">
                                    <el-input v-model="ruleForm.rzCard"  style="width: 192px;"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                    </div>
                    <div class="content_section">
                        ...
                        <div class="Tf_content">
                            <div class="clear">
                                <div class="fl">
                                    <div class="grid-content">
                                        <el-form-item  label="示例图一 :" class="img_box" >
                                            <img src="../../common/image/01.png" alt="">
                                        </el-form-item>
                                    </div>
                                </div>
                                <div  class="fl" >
                                    <div class="pre_img">
                                        <i   v-if="!ruleForm.phoneCardUrl"  class="el-icon-plus avatar-uploader-icon"></i>
                                        <img v-if="ruleForm.phoneCardUrl" :src="ruleForm.phoneCardUrl" class="avatar">
                                    </div>
                                    <el-upload
                            ...
                            <div class="clear">
                                <div  class="fl">
                                    <el-form-item :span="6" label="示例图二 :" class="img_box" >
                                        <img src="../../common/image/02.png"  alt="">
                                    </el-form-item>
                                </div>
                                <div  class="fl" >
                                    <div class="pre_img">
                                        <i  v-if="!ruleForm.phoneHandUrl" class="el-icon-plus avatar-uploader-icon"></i>
                                        <img v-if="ruleForm.phoneHandUrl" :src="ruleForm.phoneHandUrl" class="avatar">
                                    </div>
                                    <el-upload
                                        class="avatar-uploader"
                                        action="https://jsonplaceholder.typicode.com/posts/"
                    ...
                    <el-col :span="12" :offset="6">
                        <el-form-item>
                            <el-button class="btn_40" type="primary" @click="onSubmit('ruleForm')">提交</el-button>
                            <el-button  class="btn_40" @click="cancleSubmint">取消</el-button>
                        </el-form-item>
                    </el-col>
                </el-form>
            </el-row>
            <el-row v-show="submit" class="table_form mt30">
                <div class="content_section">
                ...
                <div class="tc">
                    <el-button v-if="qualifyStu=='2'" class="btn_40 blue_btn" style="width:120px;padding:0;margin:0 auto" @click="reSubmit">重新提交</el-button>
                </div>
            </el-row>
        </div>
    ...
    export default{
        ...
        methods:{
            ...
            identityCardFunc(file){
                ...
                if (!isJPG) {
                    this.tipsMessage('只支持JPG、PNG、JPEG格式!','error')
                    return false
                }
                if (!isLt2M) {
            ...
            listenCropperDate(data){
                ...
                console.log(data);
                if(data.parentData.type == '1'){
                    this.ruleForm.rzPhoneCard = data.save_id
                    this.ruleForm.phoneCardUrl  = data.show_url
                }
                if(data.parentData.type == '2'){
                    this.ruleForm.rzPhoneHand = data.save_id
                    this.ruleForm.phoneHandUrl  = data.show_url
                }
            }
        }
    }
