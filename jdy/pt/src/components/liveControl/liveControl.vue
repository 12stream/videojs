    ...
    <div class="liveControl">
        ...
        <div class="liveControl-main liveControl-wrap">
            <el-row class="w1000 mt20">
                <!-- <el-button type="primary" v-if="openLoogFlag" class="btn1" @click="loogAddress">观看地址</el-button>
                <el-dialog
                title="提示"
                :visible.sync="openAddressFlag"
                width="50%"
                >
                <div class="addresLeft clearfix">
                    <p class="addresLeft_l">观看地址</p>
                    <div class="addresLeft_t">
                        <input type="text" class="addres_ipt" style="width:75%">
                        <el-button class="addres_btn" type="primary" style="width:20%;" >打开</el-button>
                    </div>
                    <div class="addres_avtive">
                        <el-button>复制</el-button>
                    </div>
                </div>
                <div class="addresRight clearfix">
                    <div class="addresRight_l">
                        <p>手机观看二维码</p>
                        <img src="" alt="">
                    </div>
                    <div class="addresRight_r">
                        <p>小程序观看二维码</p>
                        <img src="" alt="">
                    </div>
                </div>
                <span slot="footer" class="dialog-footer">
                    <el-button @click="openAddressFlag = false">取 消</el-button>
                    <el-button type="primary" @click="openAddressFlag = false">确 定</el-button>
                </span>
                </el-dialog> -->
                <el-col :span="24">
                    <div class="liveControl-top liveControl-tab mainNav">
                        <div class="lookUrl"  @mouseenter.stop="tpsMove(1)" @mouseleave.stop="tpsMove(2)">
                          <img src="../../common/image/dw2.png" width="16" height="16" style="vertical-align: bottom;"  alt="">
                          <p class="look_p">观看地址</p>
                          <div class="lookUrl_tps" v-show="tps" :class="{'tpsBox1':pathtype==1,'tpsBox2':pathType==2}" >
                            <div class="look-tps1 t_1" >
                                <div class="tps1_url" id="phoneScan"></div>
                                <p class="tps1_p">手机扫码观看</p>
                            </div>
                            <div class="look-tps2 t_1" v-show="lookCX">
                                <div class="tps1_url" id="programScan"></div>
                                <p class="tps1_p">小程序扫码观看</p>
                            </div>
                            <div class="look-tps3">
                                <h4 class="tps3_title">观看地址：</h4>
                                <div class="tps3_ipt">
                                  <input type="text" id="myIput" readonly v-model="tpUrl" class="ipt">
                                </div>
                                <div class="tps3_btn">
                                    <el-button type="primary"  class="" @click="openVid">打开视频</el-button> 
                                    <el-button @click="copyLk('myIput')">复制</el-button>
                                    <!-- <p style="display:inline-block;" @click="routerLink">嵌入设置>></p> -->
                                </div>
                            </div>
                          </div>
                        </div> 
                            ...
                            <el-tab-pane name="liveControl">
                                            ...
                                            <div class="live-wrap">
                                                    ...
                                                    <div class="video" id="video">
                                                        <div class="flash" id="flash">
                                                            <div class="p-r" v-if="viedoShow">
                                                                <!-- <img v-show="chat.logoInfo.logo_url" :src="chat.logoInfo.logo_url" class="avatar p-a" :class="'avatar' + chat.logoInfo.logo_xy">
                                                ...
                                                <div class="liveControl-title" style="padding-left:20px">
                                                    ...
                                                    <span class="liveControl-titleN">{{chat.liveStatusTxt || '直播监控'}}</span>
                                                     <el-button  class="btn red_btn" :disabled="overLive" @click="overLiveFun"  v-if="!overLive">结束直播</el-button>
                                                     <!-- <el-button  class="btn red_btn" @click="overLiveFun"  >结束直播</el-button> -->
                                                    <!-- red_btn -->
                                                </div>
                                            </div>
                                            <div class="liveControl-bom live-bom">
                                                <div class="liveControl-class te-c" style="color:#333333;font-size:12px;">直播方式 :</div>
                                                 <el-tabs v-model="activeName"   @tab-click="handleClick2">
                                                    <el-tab-pane class="pd20"   label="推流地址" name="second">
                                                        <input readonly type="text" v-model="chat.thisData.push_url" id="cpLink" class="el-input__inner">
                                                        <el-button class="btn blue_btn" @click="copyLink('cpLink')">复制</el-button>
                                                        <!-- <div class="te-c" id="qrcode"></div>
                                                        <div class="te-c fs_12" style="color: #333;">手机扫描观看</div> -->
                                                    </el-tab-pane>
                                                    <el-tab-pane class="pd20 down_app" label="手机直播" name="third">
                                                        <div class="te-c mt20">
                                                            <el-row>
                                                              <el-col :span="12" style="padding-left: 50px;">
                                                                <!-- <img  class="img_scanner" src="../../common/image/download_ma.png" alt="">
                                                                <p style="display:block;margin-top:5px;" >扫描下载手机直播工具</p> -->
                                                                <div class="img_scanner" id="appImg"></div>
                                                                <p style="display:block;margin-top:5px;color:#333333;float: left;">扫描下载手机直播工具</p>
                                                              </el-col>
                                                              <el-col :span="12">
                                                                 <div class="img_scanner" id="appImg2"></div>
                                                                <p style="display:block;margin-top:5px;color:#333333;float: left;margin-left: 10px;">手机APP扫码直播</p>
                                                              </el-col>
                                                            </el-row>
                                                            <!-- <div class="fl down_app">
                                                                <img  class="img_ewm"  src="../../common/image/download_ma.png" alt="">
                                                                <span style="display:block;margin-top:5px;" >扫描下载手机直播工具</span>
                                                            </div>
                                                            <div class="col-fff down_btn fl" style="margin-left: -50px;">
                                                               <div class="img_ewm" id="appImg"></div>
                                                                <span style="display:block;margin-top:5px;color:#333333">手机APP扫码直播</span>
                                                                <span class="download-but download-and mb20">Android 下载</span><br>
                                                                <span class="download-but download-ios">IOS 下载</span>
                                                            </div> -->
                                                        </div>
                                                    </el-tab-pane>
                                                    <!-- <el-tab-pane class="pd20 down_app four" label="小程序观看" name="four" v-if="pathType=='1'">
                                                        <div class="te-c">
                                                            <div class="fl mini_apps">
                                                                <img  class="mini_img"  :src="mini_apps" alt="">
                                                                <p style="color: #333333;">扫描观看视频</p>
                                                            </div>

                                                        </div>
                                                    </el-tab-pane> -->
                                                    <el-tab-pane class="pd20" label="设备直播" name="five" style="margin-top: 35px;">
                                                        <div class="te-c equipLink">
                                                          <el-input placeholder="请输入编码器设备号" v-model="equipUrl" type="text" :readonly="canInput">
                                                            <el-button slot="append" @click="linkLive" v-model="linkTxt" :disabled="linkDisabled" id="linkBtn2" style="width: 90px;">{{linkTxt}}</el-button>
                                                          </el-input>
                                                          <el-row class="equipSure">
                                                            <el-button type="primary"  class="eqEnsureBtn" :disabled="isBegin" id="linkBtn" @click="startLive" style="background-color: #d9d9d9;">开始直播</el-button>
                                                          </el-row>
                                                        </div>
                                                    </el-tab-pane>
                                                    ...
                                                    <!-- 拉流直播 -->
                                                    <el-tab-pane class="pd20" label="拉流直播" name="laliu" style="margin-top: 35px;">
                                                        <div class="te-c equipLink" style="line-height: 28px;overflow: hidden;">
                                                          <p style="display: inline-block;float: left;color: #999;">请输入拉流地址 :</p>
                                                          <input  type="text" v-model="laliu.inputUrl" :readonly="laliuReadonly" class="el-input__inner" style="width:376px;">
                                                          <p style="color: #999;margin-top:20px;">拉流地址支持：直播流：rtmp、rtsp、hls等，点播流：hls、mp4、flv</p>
                                                          <el-button style="margin-top:30px;background-color: #d9d9d9;" id="pullBtn" :disabled="inPull"  class="btn"  @click="pullstartLive">开始直播</el-button>
                                                        </div>
                                                    </el-tab-pane>
                                                    <!-- <el-tab-pane class="pd20" label="导播台直播" name="fourth">导播台直播</el-tab-pane> -->
                                                </el-tabs>
                                            </div>
                                        </el-col>
                                                    ...
                                                    <el-tab-pane label="公告栏" class="notice_board"  name="notice_board">
                                                        ...
                                                        <div class="notice_rules">
                                                            <div class="rules_title">
                                                                ...
                                                                <el-switch class="my_switch swi_51"
                                                                active-text="开启"
                                                                inactive-text="关闭"
                                                                active-color="#2B94FF"
                                                            ...
                                                            <el-button  class="fr btn_30"  type="primary" @click="add_noticeList()" :disabled="disabledAdd_noticeList">发送</el-button>
                                                        </div>
                                                    ...
                                                    <el-tab-pane active-name="chat" label="聊天互动" name="chat" style="padding:0">
                                                        <div class="chat bg-fff">
                                                                    ...
                                                                    <li v-for="(item,index) in chat.MsgData" class="pd10 clear">
                                                                        <div class="layout">
                                                                            <aside class="layout__aside--left fl">
                                                                                <img class="chat-img" :src="item.imgUrl || item.sender_head">
                                                                            </aside>
                                                                            <div class="layout__main fl">
                                                                                <!-- <div class="userName_date"><span class="chat-name">{{item.nickName}}</span> -->
                                                                                <div class="userName_date"><span class="chat-name">{{item.nickName}}</span><span class="tx_css" v-if="item.isAdmin && item.data.admin_tag != ''">{{item.data.admin_tag}} </span>
                                                                                <span style="color:#CCCCCC"> {{item.send_time | filterTime}} </span> </div>
                                                                                <p style="word-wrap:break-word;font-size:12px;color: #333;" :class="item.data.giftName ? 'col-red':''"><span v-show="item.data.giftName">赠送了</span>{{item.data.msgbody || item.data.giftName}}</p>
                                                                            </div>
                                                                            <aside v-show="!item.data.giftName" class="layout__aside--right fr"><span v-if="item.user_id != 0" class="cur-p blue_bor_btn" @click="prohibitMsg(item)">{{item.silence ? '解禁': '禁言'}}</span> <span class="el-icon-delete2   red_bor_btn" @click="deleteMsg(item,index)">删除</span></aside>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            <div class="chat-edit pl10 wallet-wrap">
                                                                ...
                                                                <el-input  type="textarea" v-model="chat.MsgTxt" @keyup.enter.native="sendMsg" :disabled="disabledText"  value="http://www.mwzbw/facebac.com" :placeholder="placeholderTxt"></el-input>
                                                               
                                                                <div class="icon-toux">
                                                                  <img src="../../common/image/zbtx.png" class="touxImg" alt="" @click="zbtxClick">
                                                                </div>
                                                                <!-- <span class="cur-p icon iconfont icon-hongbao" @click="dialogVisible = true"></span> -->
                                                                <span class="cur-p icon iconfont icon-xinxi" @click="openDialogVisibleInvitation"></span>
                                                                <el-button type="primary" class="fr btn_30 " :disabled="disabledText" @click="sendMsg">发送</el-button>
                                                            </div>
                                                        </div>
                                                    </el-tab-pane>
                                                    <el-tab-pane label="直播简介" name="introduce">
                                                        <div class="introduce bg-fff">
                                                            <div class="introduce-conter">
                                                                <img :src="chat.thisData.live_cover_url || defaultImgUrl">
                                                                <h3 style="color:#333333;">{{chat.thisData.live_name}}</h3>
                                                                <div class="start-time">
                                                                    <!-- <p>开始时间: {{chat.thisData.notifyBeginTime}}</p> -->
                                                                    <p>开始时间: {{chat.thisData.begin_time | filterTime}}</p>
                                                                    <!-- <p>观看权限: {{chat.thisData.live_permit == '1' ? '密码观看' : '公开'}}</p> -->
                                                                    <p>观看权限: {{chat.thisData.live_permit || '免费'}}<span style="margin-left:20px" v-if="chat.thisData.show">金额：{{chat.thisData.money}}元</span></p>
                                                                </div>
                                                                <div class="live-brief"><span>直播简介</span></div>
                                                                <div v-for="list in chat.thisData.live_text_imgs" style="color:#000;">
                                                                    <div style="word-wrap: break-word;color: #000;">{{list.contentDesc}}</div>
                                                        ...
                                                        <div v-if="giftList.isData" class="introduce contribution bg-fff">
                                                            <ul class="pd20">
                                                                <li v-for="(item,index) in giftList.data" class="clear mb10 pb10">
                                                                    <span class="fr mlr10" style="color: #333;">
                                                                        <img class="bin_icon fl" :src="giftList.bin_icon">
                                                                        <span class="fl" style="color: #333;">{{item.amount}}</span>
                                                                    </span>
                                                                    ...
                                                                    <span class="fl mlr10" style="color: #333;">{{item.userName}}</span>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="contribution p-r" else>
                                                            <div class="giftListNotList p-a">
                                                                <div class="default-color">您还没有礼物哦！</div>
                                                            </div>

                                                            <!-- <img class="giftListNotList p-a" src="http://mwfore.mvaas.cn/H5/videoplayer/mw_liveKing/17/image/mobile/no_paihang.png" alt=""> -->
                                                        </div>
                                                    </el-tab-pane>
                                                               ...
                                                               <li v-for="(item,index) in videoList.data"    class="item_box">
                                                                    <div class="item">
                                                                        <div class="item_img fl">
                                                                            <img src="../../common/image/icon_play.png"  class="play_icon" alt="" @click="playVideo(item.file_path)">
                                                                            <img class="fl"  v-show="item.source_type!=1" :src="item.video_cover_url">
                                                                            <img class="fl" v-show="item.source_type==1" :src="item.live_cover_url">
                                                                        </div>
                                                                        <div class="item_info">
                                                                            <p style="color: #333;">{{item.live_name}}</p>
                                                                            <p class="col_9B">时间 : {{item.record_time | filterTime}}</p>
                                                                        </div>
                                                                        <div class="item_btnG">
                                                                            <el-button v-if="item.top==1" class="btn  btn_24  hover_red" @click="setTop(item,'0')">取消置顶</el-button>
                                                                            <el-button v-if="item.top!=1" class="btn  btn_24 hover_orange" @click="setTop(item,'1')">置顶</el-button>
                                                                            <!-- <el-button class="btn  btn_24 hover_blue"  @click="editVideo(item)">编辑</el-button> -->
                                                                            <el-button class="btn  btn_24 hover_red"  @click="soldVideo(item,item.video_switch)">{{item.video_switch =="0"?'下线':'上线'}}</el-button>
                                                                        </div>
                                                                    </div>
                                                               </li>
                                                            </ul>
                                                        ...
                                                        <div class="videoList p-r" else>
                                                            <div class="no_data">
                                                             ...
                                                             <div class="tip_no_data">
                                                                ...
                                                                <!-- <router-link tag="div" to="/liveControl/videoList"   class="d-ib txt_blue">录像管理上传</router-link> -->
                                                                <!-- <a class="d-ib txt_blue" @click="toVideoUpload">录像管理上传</a> -->
                                                            </div>
                                                        </div>
                                                    </el-tab-pane>
                                                </el-tabs>
                                ...
                                <!--<el-row>
                                         <div class="channel-management">
                                            <div class="default-color liveInfo-top">直播信息</div>
                                                ...
                                                <el-row>
                                                    <el-col :span="24" class="clear">
                                                        <div class="fl">
                                                            <ul>
                                                                <li class="clear">
                                                                    <div class="fl channel-le te-r">直播标题:</div>
                                                                    <div class="fl channel-re">{{chat.thisData.live_name}}</div>
                                                                </li>
                                                                <li class="clear">
                                                                    <div class="fl channel-le te-r">直播简介:</div>
                                                                    <div class="fl channel-re">{{chat.thisData.live_text || '我的精彩直播'}}</div>
                                                                </li>
                                                                <li class="clear">
                                                                    <div class="fl channel-le te-r">参与方式:</div>
                                                                    <div class="fl channel-re">{{chat.thisData.live_permit || '公开'}}</div>
                                                                </li>
                                                                <li class="clear">
                                                                    <div class="fl channel-le te-r">直播时间:</div>
                                                                    <div class="fl channel-re">{{chat.thisData.time || '暂无' }}</div>
                                                                </li>
                                                                <li class="clear">
                                                                    <div class="fl channel-le te-r">推流地址:</div>
                                                                    <div class="fl channel-re">
                                                                        <input readonly type="text" v-model="dataList.url" class="el-input__inner" style="width:200px" value="http://www.mwzbw/facebac.com"></input>
                                                                        <el-button @click="copyLink('cpLink')">复制</el-button>
                                                                    </div>
                                                                </li>
                                                                <li class="clear">
                                                                    <div class="fl channel-le te-r">观看页面地址:</div>
                                                                    <div class="fl channel-re">
                                                                        <input readonly id="cpLink3" type="text" v-model="addressUrl.watchAddress" class="el-input__inner" style="width:200px" value="http://www.mwzbw/facebac.com"></input>
                                                                        <el-button @click="copyLink(cpLink3)">复制</el-button>
                                                                    </div>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="fl">
                                                            <img class="channel-img" :src="this.chat.thisData.live_cover_url || this.dataList.imgurl">
                                                        </div>
                                                    </el-col>
                                                </el-row>
                                            </div>
                            ...
                            <el-tab-pane name="management2">
                                ...
                                <el-row class="clear">
                                    ...
                                    <el-col :span="19" style="width:970px;overflow: hidden;" class="my_list">
                                        <router-view @refresh="_createData" @changeLogin="changeLogoInfo" :changeLogoMsg="changeLogoMsg" :child-data="chat.live_switch"></router-view>
                                    </el-col>
                                </el-row>
                            </el-tab-pane>
                                ...
                                <div class="lives-Statistics">
                                    <!-- 直播统计 -->
                                     <div class="Statistics-content content_section">
                                        <div class="title">{{roomName}}服务费统计</div>
                                        <el-row class="te-c statisticsTitle">
                                            <el-col :span="24">
                                                <div>直播服务费 (元)</div>
                                                <div class="col_4FF">{{liveStatistics.liveService}}</div>
                                            </el-col>
                                        </el-row>

                                    </div>
                                    <div class="Statistics-content content_section">
                                        <div class="title">{{roomName}}直播统计</div>
                                        <el-row class="te-c statisticsTitle">
                                            <el-col :span="6">
                                                <div>经济收益 (梦豆)</div>
                                        ...
                                        <el-row class="te-c statisticsTitle">
                                            ...
                                            <el-col :span="6">
                                                <!-- <div>门票付费 (元)</div>
                                                <div class="col_4FF">{{liveStatistics.virtualTicket}}</div> -->
                                            </el-col>
                                            <el-col :span="6">
                                                <!-- <div>参与互动人数 (人)</div>
                                        ...
                                        <!-- <div class="col_9B" style="font-size:12px;margin-top:10px;">备注 : 直播收费每人人每分钟0.03元</div> -->
                                    </div>
                                    <!-- 录像统计 -->
                                    <div class="Statistics-content content_section">
                                        <div class="title">{{roomName}}录播统计</div>
                                        <el-row class="te-c statisticsTitle">
                                            <!-- <el-col :span="6">
                                                <div>直播服务收费 (元)</div>
                                                <div class="col_4FF">{{recordedStatistics.liveService}}</div>
                                            </el-col> -->
                                            <el-col :span="6">
                                                <div>经济收益 (梦豆)</div>
                                    ...
                                    <!-- <div class="Statistics-content content_section search">
                                        <span class="mr10">为以下数据筛选时间 :</span>
                                        <el-date-picker
                                            v-model="beginTime"
                                            type="datetime"
                                            placeholder="开始时间">
                                        ...
                                        <el-date-picker
                                         ...
                                         <el-button class="btn btn_34 blue_btn" type="button">查询</el-button>
                                    </div> -->
                                    <!-- 数据统计 -->
                                    <div class="my_chart">
                                        <div class="clear">
                        ...
                        <div class="main-title">
                          <el-breadcrumb separator-class="el-icon-arrow-right">
                            <el-breadcrumb-item @click.native="goManagement1">{{roomType}}</el-breadcrumb-item>
                            <el-breadcrumb-item><div class="breadcrumb-item-title">{{chat.thisData.live_name || '我的精彩点播'}}</div></el-breadcrumb-item>
                          </el-breadcrumb>
                        </div>
                    </div>
                </el-col>
            ...
            <!-- 主播头像设置 -->
            <el-dialog close="zbtx_dialog"
                title="基础设置"
                width="600px"
                :visible.sync="zbtx.visible"
                size="tiny"
            >

              <!-- <div class="zbtxDiabox">
              ...
              <div class="zbtxDiabox">
                ...
                <p class="aP1">
                  <el-upload
                    ...
                    accept=".jpg, .png, .jpeg"
                    :show-file-list="true"
                    :on-change="imgUploChange"
                    :file-list="imgArr"
                    >
                    <div style="width:40px;height:40px;">
                      <img v-if="zbtxImgUrl" v-bind:src="zbtxImgUrl"  class="avatar">
                    </div>
                    </el-upload>
                </p>
              </div>
              <div class="zbtxDiabox">
                  <span class="span1">修改头衔: </span>
                  <input type="text"> 
              </div> -->
                <el-form label-position="right" label-width="90px" class="user_ipt">
                    <el-form-item label="用户名称 :" >
                        <el-input class="input_200" v-model="myName" :maxlength="30" disabled=""></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="修改头衔 :">
                        <el-input class="input_200" v-model="setVal" :maxlength="4"></el-input>
                    </el-form-item>
                </el-form>
                <span slot="footer" class="dialog-footer">
                  <el-button type="primary" @click="zbtxBC">确 定</el-button>
                </span>
                                ...
                                <div class="p-a bgfff te-r" style="left:0;top:0px;width:100%;height:45px;padding-top:20px;margin-bottom:0px !important;background：#fff;z-index:999;">
                                    ...
                                    <span class="msgInfo-button bor_blue col-fff cur-p p-r mr10">
                                        ...
                                        <span class="p-a" style="top:0;left:0;" >
                                            <input style="width:68px;height:30px;opacity:0;" class="cur-p" id="upload" type="file" value="导入" @change="importfPhone(this,$event)"  accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" />
                                        </span>
                                    </span>
                ...
                <el-form :model="ruleFormEdit"  ref="ruleFormEdit"  label-position="right" label-width="88px" class="mt5">
                    ...
                    :rules="[
                        ...
                        <el-upload v-show="ruleFormEdit.videoCover"
                            ...
                            :before-upload="beforeAvatarUpload"
                            >
                            <span style="color:#2B94FF;;position: relative;top:-2px;left:18px;" >重新上传</span>
                        </el-upload>
                    </el-form-item>
...
export default {
  data() {
    ...
    return {
      ...
      inPull:true,
      myName1:'',
      tpUrl:PLAY_URL + getLStorage("liveID"),
      tps:'',
      stati:'',
      myTxt:'',
      openLoogFlag:true,
      ...
      imgArr:[],
      iconImg2:'',
      zbtxImgUrl:'../../common/image/zbtx.png',
      // loading:true,
      pathType: getLStorage("type"),
  ...
  created() {
    ...
    this.getEquipNo();
    if (this.pathType == 1) {
        this.tpUrl = PLAY_URL + getLStorage("liveID");
        this.lookCX = true;
    }else{
        this.tpUrl =  LIVEH5_URL+ '?liveid=' + getLStorage("liveID")
        this.lookCX = false;
    }
    this.getLiveState()
  },
  methods: {
      changeLink(){
          console.log('babagagaaaf')
      },
    pullstartLive(){
        // this.setplaySize();
        if (!this.laliu.inputUrl) {
            this.$message({
                showClose: true,
                type: "error",
                message: "拉流地址不能为空"
        ...
        var str = "^(rtmp|rtsp):\\/\\/([\\w\\-\\.,@?^=%&:/~\\+#]+:)?([\\w\\-\\.,@?^=%&:/~\\+#]+@)?[\\w\\-_]+(\\.[\\w\\-_]+)+([\\w\\-,@?^=%&:/~\\+#]*[\\w\\-\\@?^=%&/~\\+#])?$";
        var reg2 = new RegExp(str);

        let reg =/http:\/\/([\w\-\.,@?^=%&:/~\+#]+:)?([\w\-\.,@?^=%&:/~\+#]+@)?[\w\-_]+(\.[\w\-_]+)+([\w\-\.,@?^=%&:/~\+#]*[\w\-\@?^=%&/~\+#])?$/;
        // let reg2 = /^(rtmp|rtsp):\\/\\/([\\w\\-\\.,@?^=%&:/~\\+#]+:)?([\\w\\-\\.,@?^=%&:/~\\+#]+@)?[\\w\\-_]+(\\.[\\w\\-_]+)+([\\w\\-,@?^=%&:/~\\+#]*[\\w\\-\\@?^=%&/~\\+#])?$/
        if (!reg.test(this.laliu.inputUrl) && !reg2.test(this.laliu.inputUrl)) {
            this.tipsMessage('播放失败，请检查地址是否正确！','error')
            return
        }
        let liveUrl = DATA_URL + 'mwlive/live/startPullLive.do'
        let formdata = new FormData()
        formdata.append('liveId',getLStorage("liveID"))
        formdata.append('userId',getLStorage("user_id"))
        formdata.append('pullUrl',this.laliu.inputUrl)
        axios({
            method: 'post',
            url: liveUrl,
            data:formdata,
            ...
            if (res.data.code == 200) {
                ...
                this.liveState = 1;
                this.inPull = true;
                $('#pullBtn').css('background','#d9d9d9');
                this.laliuReadonly = true;
            }else{
                this.tipsMessage('播放失败，请检查地址是否正确！','error')
            }
        }).catch((err)=>{
    ...
    getLiveState(){
        let liveUrl = DATA_URL + 'mwlive/live/liveStream.do'
        let formdata = new FormData()
        formdata.append('liveId',getLStorage("liveID"))
        axios({
            method: 'post',
          ...
          if (res.data.code == 200) {
              this.liveState = res.data.data.status;
              console.log(this.liveState)
              if (this.liveState == 1) {
                  $('#pullBtn').html('直播中');
                  this.laliu.inputUrl = res.data.data.pull_url;
                  this.laliuReadonly = true;
              }
              if (this.liveState == 2) {
                  this.inPull = false;
                  $('#pullBtn').css('background','#2b94ff')
              }else{
                  this.inPull = true;
                  $('#pullBtn').css('background','#d9d9d9')
              }
    ...
    tpsMove(e){
      ...
      if (e == 1) {
          ...
          this.tps = true;
            if (this.pathType == "1") {
              this.qrcode = PLAY_URL + getLStorage("liveID") + "&v=1.7.0";
            } else {
              this.qrcode = LIVEH5_URL + "?liveid=" + getLStorage("liveID");
            }
            var canvas1 = qrcanvas({
              data: this.qrcode,
              size: 98
            });
            let iponeCanvas = qrcanvas({
                data:this.qrcode,
                size:80
            })
            $('#phoneScan').html('');
            $('#phoneScan').append(iponeCanvas)
        })
      }else{
        this.tps = false;
      }
    ...
    routerLink(){
      this.$router.push({ path: "/liveControl/shareEmbedded" });
    },
    copyLk(id){
    ...
    zbtxBC(){
      ...
      this.zbtx.visible = false;
      let that  = this;
      let params = {
        cmd:'set_admin_tag',
        userid:this.userID,
        // user_img :this.iconImg2,
        adminTag:this.setVal
      }
      let url = LIVE_URL + 'filterword.action';
      $.ajax({
        type: "POST",
        ...
        success: function(data) {
          if (data.resultCode == 200) {
            // this.chat.MsgData[0].nickName = this.setVal;
            // that.$message({
            //   showClose: true,
            //   type: "success",
            //   message: "设置成功"
    ...
    toVideoUpload() {
      this.activeNameTab = "management2";
      this.$router.push("/liveControl/videoList");
    },
    //回到点播控制
    goManagement1() {
    //   this.activeNameTab = "liveControl";
      if (this.pathtype == 1) {
          this.$router.push("/yunbo");
      }else{
    ...
    startLive() {
      ...
      axios({
        ...
        .then(res => {
          console.log("开始直播" + JSON.stringify(res));
          if (res.status == 200) {
            this.overLive = true;
            this._createData();
            $("#linkBtn").html("直播中");
            ...
            this.canInput=true;
            $(".equipLink .el-input-group__append").css("background", "#d9d9d9");
          }
        })
        .catch(function(err) {
          console.log(err);
      ...
      axios({
        ...
        .then(res => {
          ...
          if (res.status == 200) {
            ...
            this.linkTxt = "连接";
            $("#linkBtn").html("开始直播");
            $("#linkBtn").css("background-color", "#d9d9d9");
            this.linkDisabled=false;
            this.canInput=false;
            $(".equipLink .el-input-group__append").css("background", "#4285f4");
          }
        })
        .catch(function(err) {
          console.log(err);
        ...
        .then(res => {
          ...
          if (res.status == "200") {
            if (res.data.code == "200") {
              ...
              this.linkTxt = "断开连接";
              this.canInput=true;
              $("#linkBtn").css("background-color", "#2b94ff");
            } else {
              this.$message({
                showClose: true,
                type: "Info",
                message: this.getErrorInfo(res.data.code)
              });
            }
          } else {
            this.$confirm('连接失败请重新连接', '提示', {
    ...
    getEquipNo() {
      ...
      axios({
        ...
        .then(res => {
          ...
          if (res.status == "200") {
            this.equipUrl = res.data.data.deviceCode;
           if(res.data.data.status==1 && this.stati){
             this.isBegin=true;
             this.linkDisabled=true;
             $("#linkBtn").html("直播中");
            $("#linkBtn").css("background", "#d9d9d9");
    ...
    playVideo(url) {
      ...
      this.$alert(
        '<video style=" min-width:720px;min-height:406px;"  id="preVideo"  class="video-js vjs-default-skin" controls ebkit-playsinline="true" autobuffer preload="auto" poster="" x-webkit-airplay="true" webkit-playsinline="true" playsinline></video>',
        "录像预览",
        {
    ...
    submitFormIsInvitation() {
      ...
      // this.dynamicValidateForm.msg = getLStorage('admin') + ' 告知您参加《来一场说开就开的直播》的直播。直播在2017年12月8日，9点30分开始。详情请点击http://pt.facebac.com/l/17/' + getLStorage('liveID')
      for (var i = 0; i < len; i++) {
        if (i === 0) {
      ...
      console.log("dynamicValidateForm", dataNum);
      let formdata = new FormData();
      formdata.append("user_id", getLStorage("user_id"));
      ...
      axiosData(formdata, DATA_URL + "mwlive/user/get_userinfo.do").then(
        res => {
          if (res.data.code == ERR_OK) {
            ...
            this.myName = res.data.data.user_title;
    ...
    addRow() {
      // var APPimg =
      //   'http://a.app.qq.com/o/simple.jsp?pkgname=com.montnets.live&liveInfo={"type":"type","data":{"pushAddr":"' +
      //   this.dataListUrl.url +
      //   '","liveName":"' +
      //   this.chat.thisData.live_name +
      //   '"}}';
      var APPimg =
        "http://a.app.qq.com/o/simple.jsp?pkgname=com.montnets.live&liveId=" +
        getLStorage("liveID");
      console.log(APPimg);
    ...
    //   document.getElementById("qrcode").appendChild(canvas1);
      ...
      var canvas3 = qrcanvas({
        data: APPimg,
        size: 98
      });
      document.getElementById("appImg").innerHTML = "";
      document.getElementById("appImg2").innerHTML = "";
      document.getElementById("appImg").appendChild(canvas2);
      document.getElementById("appImg2").appendChild(canvas3);
    },
    copyLink(data) {
      copyLink(data);
      this.tipsMessage("复制成功！");
    ...
    handleScroll() {
      ...
      if (this.scroll.scrollTop === 0) {
        // console.log(this.chat.MsgData[0].msg_id)
        // console.log('scroll!',this.scroll.scrollTop)
    ...
    changeLogoInfo(changeLogoMsg) {
      console.log("LOGOGOGOGOmsg", changeLogoMsg);
    ...
    _getLogonInfo() {
      axios
        ...
        .then(response => {
          console.log("response1 LOGO", response);
    ...
    _scrollTop() {
      ...
      // console.log(this.chat._scrollBody)
      this.$nextTick(() => {
        this.chat._scrollBody = document.getElementById("scrollBody");
        console.log("this.chat._scrollBody", this.chat._scrollBody.scrollTop);
        console.log("this.chat._scrollBody", this.chat._scrollBody.height);
      });
    },
    get_miniApps() {
        ...
        .then(response => {
          if (response.data.code == ERR_OK) {
            ...
            let iponeCanvas = qrcanvas({
                ...
                $('#programScan').html('');
                $('#programScan').append(iponeCanvas)
          }
        })
        .catch(function(err) {
          console.log(err);
    ...
    _isData() {
      ...
      if (global.liveData.DataStatistics) {
        this.activeNameTab = "management3";
        global.liveData.DataStatistics = false;
      }
      this._createData();

      // if(global.liveData.data){
      //     console.log('isData')
      //     axios.get(DATA_URL + 'mwlive/live/get_listbyuser.do?user_id='+ getLStorage('user_id')
      //     ).then((response) => {
      //         if(response.status === ERR_OK){
      //             global.liveData.data = this.dataList = filterStatus(response.data.data.data_list)
      //         }
      //     }).catch(function(err){
      //         console.log(err)
      //     })
    ...
    _createData() {
      // console.log("created",global.liveData.data)

      // this.dataListNav = global.liveData.AllData

      // this.chat.data = this.dataList = global.liveData.data

      // console.log('this.dataList.thisData',this.chat.data)

      // this.chat.liveID = global.liveData.thisID = this.chat.thisData.id
      // this.chat.liveID = global.liveData.thisID = global.liveData.liveID
      // this.chat.live_switch = this.chat.thisData.live_switch

      // sessionStorage 获取 liveID
      let live_id = getLStorage("liveID");
      let mytype = '';
      if (this.pathType == 2) {
          mytype = 1;
      ...
      axios
        .get(DATA_URL + "mwlive/live/get_info.do?id=" + live_id +'&' + 'type=' + mytype)
        .then(response => {
          if (response.data.code == ERR_OK) {
            this.chat.thisData.live_Logo = response.data.data.live_Logo;
            this.qrcode = response.data.data.play_url;
            // this.tpUrl = response.data.data.play_url;
            // console.log('response.data.data.live_switch',response.data.data)
            // if(response.data.data.live_switch == 1){
            //     response.data.data.live_switch = false
            // }else{
            //     response.data.data.live_switch = true
            // }
            ...
            // 禁播状态
            // if (data.live_switch == 1) {
            //     data.live_switch = false
            // } else {
            //     data.live_switch = true
            // }
            ...
            // this.chat.thisData = response.data.data
            this.chat.thisData = data;
            console.log(this.chat);
            // 邀请时间
            var urlSMS = MSGURL + getLStorage("liveID");
            if (this.pathType == "2") {
              urlSMS = LIVEH5_URL + "?liveid=" + getLStorage("liveID");
            }
            var pwdstr="";
            if(this.chat.thisData.live_permit=="加密"){pwdstr="直播间密码为"+this.chat.thisData.view_pass+",";}
            if (this.chat.thisData.notifyBeginTime) {
              switch (this.chat.thisData.live_status) {
                //getLStorage("admin")
                case 0:
                  this.dynamicValidateForm.msg =
                    getLStorage("mobile") +
                    " 告知您参加《" +
                    this.chat.thisData.live_name +
                    "》的直播。"+pwdstr+"直播将在" +
                    setDateTime(this.chat.thisData.notifyBeginTime, true) +
                    "开始。详情请点击" +
                    urlSMS;
                  break;
                case 1:
                ...
                case 2:
                  this.dynamicValidateForm.msg =
                    ...
                    " 告知您参加《" +
                    this.chat.thisData.live_name +
                    "》的直播。"+pwdstr+"已经生成回放，赶快来观看吧。详情请点击" +
                    urlSMS;
                  break;
                case 4:
                  this.dynamicValidateForm.msg =
                    ...
                    " 告知您参加《" +
                    this.chat.thisData.live_name +
                    "》的直播。"+pwdstr+"该直播的预告已过期，感谢您的关注。详情请点击" +
                    urlSMS;
                  break;
                case 5:
                  this.dynamicValidateForm.msg =
              ...
              //     this.chat.thisData.live_name +
              //     "》的直播。直播在" +
              //     setDateTime(this.chat.thisData.create_time, true) +
              //     "开始。详情请点击" +
              //     MSGURL +
              //     getLStorage("liveID");
              // }
              switch (this.chat.thisData.live_status) {
                case 0:
                  this.dynamicValidateForm.msg =
                    ...
                    this.chat.thisData.live_name +
                    "》的直播。"+pwdstr+"直播将在" +
                    setDateTime(his.chat.thisData.create_time, true) +
                    "开始。详情请点击" +
                    urlSMS;
                  break;
                case 1:
            ...
            if (this.chat.thisData.live_switch == 0) {
              ...
              // this.chat.thisData.live_switch = false
            }
            ...
            if (this.chat.thisData.live_text_imgs !== "") {
              this.chat.thisData.live_text_imgs = JSON.parse(
                this.chat.thisData.live_text_imgs
              );
            }

            this.dataListUrl.url = response.data.data.push_url;
            this.chat.playLiveUrl = this.chat.liveUrl =
              response.data.data.play_url;
            // 直播状态获取

            this.chat.liveStatus = response.data.data.live_status;
            console.log(this.chat.liveStatus)
            this._createSocket();
          }
        })
        .catch(function(err) {
    ...
    //     axios({
    //         method: 'get',
    //         url: DATA_URL + 'mwlive/live/get_info.do?id=' + this.chat.thisData.id
    //     }).then((response)=>{
    //         if(response.data.code == ERR_OK){

    //             console.log('get_info.do',response.data.data.play_url,response.data.data.live_status)
    //             this.dataListUrl.url = response.data.data.push_url
    //             this.chat.liveUrl = response.data.data.play_url
    //             // this.chat.liveStatus = response.data.data.live_status
    //             // this.changeLiveShow()
    ...
    _createSocket(flag) {
      ...
      if (this.chat.isSocket) {
        ...
        axios({
          ...
          .then(response => {
            ...
            //yst直播结束设置
            // this.chat.thisData.live_cover_img = response.data.end_show_img || this.chat.thisData.live_cover_url
            ...
            // if(response.data.end_show_type == 0 && response.data.end_show_img){
            //     this.chat.thisData.live_cover_img = response.data.end_show_img
            // }else if(response.data.end_show_type == 0){
            //     console.log(this.chat.thisData.live_cover_url,'this.chat.thisData.live_cover_url')
            //     this.chat.thisData.live_cover_img = this.chat.thisData.live_cover_url
            // }else if(response.data.end_show_type == 1 && response.data.end_show_vod ==''){
            //     let formdata = new FormData()
            ...
            //     this.viedoShow = true
            //     axiosData(formdata,DATA_URL + 'mwlive/live/get_reclistbyselect.do').then(res => {
            //         if(res.data.code == ERR_OK){
            //             console.log('默认录像',res.data.data.data_list[0].file_path)
            ...
            // this.chat.end_show_type = response.data.end_show_type
            // if(this.chat.end_show_type == 0){
            //     this.chat.end_show_val = response.data.end_show_img
            //     getLStorage('end_show_val',this.chat.end_show_val)
            // }else{
            //     this.chat.end_show_val = response.data.end_show_vod
            //     getLStorage('end_show_val',this.chat.end_show_val)
            // }
            // getLStorage('end_show_type',this.chat.end_show_type)
      ...
      // console.log('liveID: this.chat.thisData.id',this.chat.thisData.id)
    },
    _scrollTop() {
      setTimeout(() => {
        ...
        //   console.log(sysMsg)
          ...
          switch (sysMsg.cmd) {
            case 1001:
              ...
              console.log('afadfafa')
              if (sysMsg.msg == '加入房间') {
                  if (sysMsg.data.silence_all == 1) {
                      console.log('全体禁言')
                      this.silence_all =  false;
                  }else{
                      console.log('全体解除禁言')
                      this.silence_all = true;
                  }
              }
              console.log(sysMsg)
              // console.log('1001人数',this.chat.Msg.data)
              break;
            case 1004:
              // 聊天室通用消息
            ...
            case 1005:
              // 自定义消息 礼物消息
              console.log("礼物消息：");
              console.log("礼物消息：" + this.chat.Msg);
              console.log(this.chat.Msg.sender_head);
            ...
            case 2020:
              ...
              for (var i = 0; i < this.chat.Msg.data.allsms.length; i++) {
                ...
                console.log("历史聊天记录", this.chat.Msg.data.allsms[i]);
              }
              break;
            case 2021:
              // 清除聊天记录
              console.log("清除聊天记录", this.chat.Msg.data);
              break;
            case 2023:
              // 清屏
              console.log("清屏", this.chat.Msg.data.show_msg);
              if (this.chat.Msg.data.show_msg == 0) {
                this.disabledText = true;
                this.placeholderTxt = "全体观众已经被禁言";
              } else {
            ...
            case 2024:
              // 全体禁言
              console.log("全体禁言", this.chat.Msg.data.show_msg);
              if (this.chat.Msg.data.show_msg == 0) {
                this.disabledText = true;
                this.placeholderTxt = "全体观众已经被禁言";
              } else {
            ...
            case 2010:
              ...
              console.log("禁播名单", this.bannedList);
              break;
            case 5001:
              //console.log(msg);
              ...
              break;
              case 6031:
                if (this.chat.Msg.data.status == 1) {
                    console.log(this.chat.Msg.data,'头衔设置')
                    this.$nextTick(()=>{
                        if (Array.isArray(that.chat.MsgData) && that.chat.MsgData.length > 0) {
                            that.chat.MsgData.forEach((e,index)=>{
                                if (e.user_id == getLStorage("user_id")) {
                                    // this.chat.MsgData[index].adminTag = this.chat.Msg.data.admin_tag;
                                    // that.$set(that.chat.MsgData[index].admin_tag,that.chat.Msg.data.admin_tag)
                                }                    
                            })
                            that.$message({
                                showClose: true,
    ...
    getOverLive(data) {
      ...
      if (data.data.end_show_type == 1 && data.data.end_show_vod) {
        console.log("===========自定义视频" + data.data.end_show_vod);
        // this.viedoShow = true
        this.chat.liveUrl = data.data.end_show_vod;
        // this.chat.isplay = true
        let videoBox = document.getElementById("videoA1");
        ...
        // this.chat.liveUrl = data.data.end_show_vod
        // this.chat.isplay = true
        // this.chat.thisData.live_cover_img = this.chat.thisData.live_cover_url || this.defaultImgUrl
        let videoBox = document.getElementById("videoA1");
        this.videotape();
      } else if (data.data.end_show_type == 0 && data.data.end_show_img) {
        this.chat.thisData.live_cover_img = data.data.end_show_img;
      } else if (data.data.end_show_type == 0 && data.data.end_show_vod == "") {
        this.chat.thisData.live_cover_img =
      ...
      axios({
        ...
        if (res.data.code == ERR_OK) {
          if (res.data.data.data_list == null) {
            this.chat.thisData.live_cover_img =
              this.chat.thisData.live_cover_img ||
              this.chat.thisData.live_cover_url;
            this.viedoShow = false;
            this.chat.isplay = false;
            return false;
            // this.chat.thisData.live_cover_img = this.chat.thisData.live_cover_img || this.chat.thisData.live_cover_url
            // let videoBox = document.getElementById('videoA1')
            // this.liveSetInterval = window.setInterval(()=>{
            //     this.videotape()
            // },10000)
          }
          if (res.data.data.data_list[0].video_switch == 2||res.data.data.live_after_type == 1) {
            this.chat.thisData.live_cover_img =this.chat.thisData.live_cover_url || this.defaultImgUrl;
            return false;
          }
          if (res.data.data.live_after_type == "2") {
              console.log("自定义录像!!", res.data.data.live_after_url);
            this.chat.liveUrl = res.data.data.live_after_url;
            this.viedoShow = true;
            this.chat.isplay = true;
            setTimeout(() => {
              this.setplaySize();
          ...
          //1.7判断逻辑
          // if (res.data.data.data_list[0].source_type == "2") {
          //   console.log("自定义录像!!", res.data.data.data_list[0].file_path);
          //   this.chat.liveUrl = res.data.data.data_list[0].file_path;
          //   this.viedoShow = true;
          //   this.chat.isplay = true;
          //   setTimeout(() => {
    ...
    sendMsg() {
      ...
      if (
        ...
        this.socket.emit("msg", {
          ...
          cmd: 1004,
          msg: "弹幕",
          nickName:this.myName ||"管理员", //nickname,
          user_id: this.chat.user_id,
          barrage: parseInt(0),
          data: {
            msgbody: this.chat.MsgTxt
          },
          admin_tag:this.setVal
        });
        this.chat.MsgTxt = "";
      }
    },
    ...
    ClearScreen() {
      if (this.socket) {
        this.silence_all = this.silence_all ? true : false;
        this.socket.emit("msg", {
          cmd: 2024,
          msg: "全体禁言",
          data: {
            silence_all: this.silence_all ? 0 : 1
          }
        });
        this.$message({
          showClose: true,
          type: "info",
          message: this.silence_all
            ? "取消禁言"
            : "全体用户已被禁言。"
        });
      }
    ...
    prohibitMsg(item) {
        if (item.isAdmin == 1) {
            return this.tipsMessage("管理员不能被禁言");
        }
      if (this.socket) {
    ...
    handleClick(tab, event) {
      ...
      if (event.target.innerText === "频道管理" || event.target.innerText === "数据统计") {
          this.openLoogFlag = false;
          if (event.target.innerText === "频道管理") {
              rootBus.$emit('updateTab','management2')
          }else{
              rootBus.$emit('updateTab','management3')
          }
      }else{
          this.openLoogFlag = true;
      ...
      this.$router.push({
        path: "/liveControl",
        query: { type: this.pathType } //1表示云播 2代表视频中心 3代表点播
      });
    },
    ...
    _LiveStatus() {
      ...
      if (this.chat.live_switch) {
        // if(this.chat.thisData.live_switch){
        let formdata = new FormData();
    ...
    _getStatisticsData() {
      ...
      axios({
        ...
        .then(res => {
          ...
          // 直播统计
          _this.liveStatistics = _this.liveCount[0];
          // 录播统计
          _this.recordedStatistics = _this.liveCount[1];
          // 观看时长分析
          var lookTimeV = _this.liveCount[2];
          ...
          var myChart3 = echarts.init(
            document.getElementById("statisticsMain3")
          );
          var myChart4 = echarts.init(
            document.getElementById("statisticsMain4")
          );
            ...
            series: [
              {
                ...
                radius: "55%",
                data: [
                  //update by xsliu 20180518 65227
                  { value: _this.liveStatistics.h5ClientCount, name: "H5观看" },
                  {
                    value: _this.liveStatistics.pcClientCount,
                    name: "网页观看"
                  },
                  {
                    value: _this.liveStatistics.mobileClientCount,
                    name: "App观看"
                  }
                  // {value:_this.liveStatistics.pcClientCount, name:'pc端'},
                  // {value:_this.liveStatistics.mobileClientCount+_this.liveStatistics.h5ClientCount, name:'移动端'},
                ]
              }
            ]
          };
            ...
            series: [
              {
                ...
                data: [
                  ...
                  // {value:_this.recordedStatistics.mobileClientCount+_this.recordedStatistics.h5ClientCount, name:'移动端'},
                ],
                itemStyle: {
                  normal: {
                    color: "#1890ff"
          ...
          // console.log("1、"+JSON.stringify(this.liveStatistics))
    ...
    overLiveFun() {
      ...
      if (this.liveState == 1) {
          let formdata2 = new FormData();
              ...
              formdata2.append("liveId", getLStorage("liveID"));
              formdata2.append("pullUrl", this.laliu.inputUrl);
              axios({
                method: "post",
                url: DATA_URL + "mwlive/live/endPullLive.do",
                data: formdata2,
                headers: { "Content-Type": "multipart/form-data" }
              })
                .then(res => {
                    this.inPull = false;
                    this.laliuReadonly = false;
                    $('#pullBtn').html('开始直播');
                    $('#pullBtn').css('background','#2b94ff')
                })
        }
    ...
    endLive() {
      ...
      axios({
        method: "post",
        url: DATA_URL + "mwlive/live/record_stop.do",
        data: formdata,
        headers: { "Content-Type": "multipart/form-data" }
      })
        .then(res => {
          if (res.data.code == ERR_OK) {
            this.tipsMessage("直播已结束");
          } else {
            this.tipsMessage("操作失败");
          }
        })
    ...
    sendToApp() {
      this.socket.emit("msg", {
        ...
        msg: "自定义消息",
        nickname: this.chat.Msg.nickName,
        user_id: this.userID,
        room_id: this.chat.out_roomID,
        liveID: this.chat.thisData.id,
        user_Type:"100",
        gender:0,
        qualify:"3",
    ...
    openVid(){
        let url = PLAY_URL + getLStorage("liveID");
        window.open(url)
    }
  },
  destroyed() {
...
/* .wallet-wrap .icon-touxiang::before{
  background: url(../../common/image/zbtx.png);
  top: -20px;
} */
...
.mainNav .liveControl-bom .el-tabs__nav .el-tabs__item:hover,
...
.liveControl-bom .el-tabs__item.is-active {
  border-top: 3px solid #2b94ff !important;
  height: 40px;
}
.liveControl-tab
  .liveControl-bom
...
.notice_board .swi_51 .el-switch__core {
  width: 46px !important;
  height: 22px !important;
}
.notice_board .swi_51 .el-switch__core .el-switch__button {
  width: 16px;
  height: 16px;
}
.notice_board .swi_51 .el-switch__core:after {
  top: 3px;
}
.el-popover {
...
.lookUrl_tps{
    ...
    min-width: 450px;
    /* background-image: url('../../common/image/liveBg1.png');
...
.tx_css{
    display: inline-block;
    height: 16px;
    background: linear-gradient(90deg,rgba(32,105,227,1),rgba(83,160,253,1));
    border-radius: 2px;
    padding: 2px 10px;
    text-align: center;
    line-height: 16px;
