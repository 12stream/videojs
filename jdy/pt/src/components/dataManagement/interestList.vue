<template>
    <div class="my_list fanList">
        <div class="live-top bg-fff">关注列表</div>
        <div class="bg-fff info-content" >
            ...
            <div v-if="noDate" class="no_live">
                <div class="no_data">                                                                                                                          
                    ...
                    <span class="default-color">您还没有关注的人哦！</span>                    
                </div>
            </div>
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            getDataList(val){
                let url = GIFT_URL + 'service/queryFollow.action'
                let formdata = new FormData()
                formdata.append('fansID',getLStorage('user_id'))
