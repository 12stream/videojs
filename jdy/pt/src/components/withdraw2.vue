<template>
    <div class="withdraw my_list" style="min-height:668px;">
        ...
        <div class="bg-fff info_content">
            <div  v-if="personage">
                <el-form  v-if="!isbinding"  label-width="95px" :rules="bangding_personal_rules" ref="bangding_personal"  :model="bangding_personal">
                    <el-form-item label="姓名 :" prop="name">
                        <el-input class="my_input"  v-model="bangding_personal.name" placeholder="收款人姓名"></el-input>
                    </el-form-item>
                    <el-form-item label="卡号 : " prop="cardNo">
                        <el-input class="my_input" v-model="bangding_personal.cardNo"  placeholder="收款人储蓄卡号 "></el-input>
                    </el-form-item>
                ...
                <div v-if="isbinding">
                    ...
                    <el-form label-width="95px" :rules="tixian_personal_rules" ref="tixian_personal"  :model="tixian_personal">
                        ...
                        <el-form-item label="提现金额 : " prop="amount">
                            <el-input class="my_input" v-model="tixian_personal.amount"  placeholder="请输入提现金额 "></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="卡号 : " prop="cardNo">
                            <el-input class="my_input" :disabled="true" v-model="tixian_personal.cardNo"></el-input>
                        </el-form-item>
                        <el-form-item label="银行 : " prop="bank">
            ...
            <div v-if="company">
                ...
                <div v-if="!isbinding2">
                    <el-form  label-width="95px" :rules="rules_binding_company" ref="binding_company"  :model="binding_company">
                        ...
                        <el-form-item label="卡号 : " prop="cardNo">
                            <el-input class="my_input" v-model="binding_company.cardNo"  placeholder="企业银行储蓄卡号 "></el-input>
                        </el-form-item>
                        <el-form-item label="银行 : " prop="bank">
                ...
                <div  v-if="isbinding2">
                    ...
                    <el-form label-width="95px" :rules="Company_tixian_rules" ref="Company_tixian"  :model="Company_tixian">
                        ...
                        <el-form-item label="提现金额 : " prop="amount">
                            <el-input class="my_input"  v-model="Company_tixian.amount"  placeholder="请输入提现金额 "></el-input>
                        </el-form-item>
                        <el-form-item label="法人 : ">
                            <el-input class="my_input" :disabled="true"  v-model="Company_tixian.legalPerson" placeholder="收款人法人姓名"></el-input>
                        </el-form-item>
                        <el-form-item label="卡号 : " >
                            <el-input class="my_input" :disabled="true"  v-model="Company_tixian.cardNo"  placeholder="企业银行储蓄卡号 "></el-input>
                        </el-form-item>
                        <el-form-item label="银行 : " >
                            <el-input class="my_input"  :disabled="true" v-model="Company_tixian.bank" ></el-input>

                            <!-- <el-select v-model="Company_tixian.bank" placeholder="请选择开户银行" class="my_select">
                                <el-option
                                v-for="item in options"
                                :key="item.value"
                                :label="item.label"
...
<script>
    ...
    import {ERR_OK,DATA_URL,getLStorage,GIFT_URL,PROJET_URL,facebac_URL} from 'api/config'
    ...
    export default{
        ...
        methods: {
            ...
            ifbinding(){
                let _this = this
                let url = facebac_URL + 'mwcurrency/getCardInfo.action'
            ...
            ifbinding2(){
                ...
                .then((res)=>{
                    if(res.data.resultCode == "01"){
                        _this.Company_tixian.legalPerson =  res.data.params.name
                        _this.Company_tixian.cardNo =  res.data.params.cardNo
                        _this.Company_tixian.ird =  res.data.params.dutyNo
                        _this.Company_tixian.address =  res.data.params.address
                        _this.Company_tixian.phone =  res.data.params.phone
                        _this.Company_tixian.bank =  res.data.params.bankOpen                                               
            ...
            getBalance(){
                let _this = this
                let url = facebac_URL + 'mwcurrency/getCurrencyBalance.action'
                let formdata = new FormData()
                formdata.append('userId',getLStorage('user_id'))
                axios({
                    method: 'post',
            ...
            bindingCompany(formName){
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {  
                        _this.isbinding2 = true                   
                        _this.binding_company.legalPerson =  _this.Company_tixian.legalPerson
                        _this.binding_company.cardNo = _this.Company_tixian.cardNo
                        _this.binding_company.ird = _this.Company_tixian.ird
                        _this.binding_company.address =   _this.Company_tixian.address                      
                        _this.binding_company.bank =  _this.Company_tixian.bank  
                        _this.binding_company.phone =  _this.Company_tixian.phone
            ...
            withdraw(formName){
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        let _this = this
                        let url = facebac_URL + 'mwcurrency/addAmountCash.action'
                        let formdata = new FormData()
                        formdata.append('userId',getLStorage('user_id'))
