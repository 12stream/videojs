...
var TouchSlide = function(a){
	...
	var slideH=0;
	var slideW=$(window).width();// mainCell滑动距离，后面会覆盖
	var selfW=$(window).width();
	var scrollY ;
	...
	var tStart = function(e){
		...
		//添加“触摸移动”事件监听
		conBox.	addEventListener(touchMove, tMove);
		//添加“触摸结束”事件监听
		conBox.addEventListener(touchEnd, tEnd);
	}
	...
	var tEnd = function(e){
		...
		conBox.removeEventListener(touchMove, tMove);
		conBox.removeEventListener(touchEnd, tEnd);
	}


	//添加“触摸开始”事件监听
	conBox.addEventListener(touchStart, tStart);
